...
button.addEventListener("click", () => {
  if (button.textContent === "Click Me! ?") {
    ...
    setTimeout(() => {
      // Replace the following line with the URL of the new page you want to navigate to
      window.location.href = "new.html";
    }, 2000); // 2000 milliseconds (2 seconds) is just an example delay
  }
});
...
var footer = document.createElement("footer");
        footer.textContent = "Crafted by Rahul";
